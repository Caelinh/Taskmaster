...
//        QueryDB();
    ...
    protected void onResume() {
        ...
        if (currentUser != null){userNameEdited.setText(currentUser.getUsername());
        } else userNameEdited.setText(userName + "'s Tasks");
...
//        QueryDB();
    ...
    private void QueryDB(String team){
        Amplify.API.query(
                ModelQuery.list(Task.class, Task.TEAM.contains(team)),
                successResponse -> {
